function [codebook, centpops, centcods, fileorder] = eec201_CodeBookTrainerV2(training_folder_path, show_work)
%
%
        ...
        if and(~filelist(ind).isdir, ~strcmp(filelist(ind).name(1), '.'))
          ...
          % Calculate the mel-freq cepstrum from the spectrogram
            melFreqCept     = eec201_MelFreqCepstrum(   spectro,                                            ...
                                                        filtbank,                                           ...
                                                        melfreqs,                                           ...
                                                        frametimes, true); %yes i do it like this in real life too
